...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(company-c-headers)
...
you should place your code here."
  ...
  (with-eval-after-load 'company (setq company-idle-delay 0))
  )
...
(custom-set-variables
 ...
 '(safe-local-variable-values
   (quote
    ((helm-make-build-dir . "/home/ufan/src/software/root/build-5.34")
     (helm-make-build-dir . "./build")
     (helm-make-build-dir . "/home/ufan/workspace/mwdc/fm/workspace/test/build")))))
(custom-set-faces
